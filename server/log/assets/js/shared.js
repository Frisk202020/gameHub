...
export function enableFilterBtn(element, color) {
    element.style.backgroundColor = color;
    element.style.borderColor = "#ffd700";
}
export function disableFilterBtn(element) {
...
export function buildLogEntry(entry) {
    ...
    switch (entry.level) {
        case "ERROR":
            p.style.backgroundColor = logLevels.ERROR.color;
            break;
        case "INFO":
            p.style.backgroundColor = logLevels.INFO.color;
            break;
        case "WARN":
            p.style.backgroundColor = logLevels.WARN.color;
            break;
        case "DEBUG":
            p.style.backgroundColor = logLevels.DEBUG.color;
            break;
        case "TRACE":
            p.style.backgroundColor = logLevels.TRACE.color;
            break;
    }
    return p;
}
...
export function filterLogs(levelFilter) {
